export default {
    ...
    groups: {
      ...
      openaiMessages: {
        ...
        familyMappingHint: 'Requests that match Opus (including Fable), Sonnet, or Haiku prefer the target model configured here. Map 1M Claude models to gpt-5.6-sol (not terra); use gpt-5.6-luna for Haiku.',
